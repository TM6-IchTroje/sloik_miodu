...
import 'package:firebase_shop_app/core/providers/my_products_provider.dart';
...
class MyProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var productsData = Provider.of<MyProductsProvider>(context);
    return Scaffold(
      appBar: AppBar(
        ...
        children: <Widget>[
          Container(
            ...
            itemBuilder: (ctx, index) {
              return myproductItem(productsData.products[index], context);
            },
  ...
  // Draw productItem
  Widget myproductItem(ProductModelProvider product, BuildContext context) {
    return ListTile(
