...
class AboutUserWidget extends StatelessWidget {
  ...
  final String photo;
  String photo2 =
      "https://firebasestorage.googleapis.com/v0/b/sloik-miodu-000.appspot.com/o/pszczelarz1.jpg?alt=media&token=2959601b-a86e-4cb2-bf3a-6fa710ed510e";
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(this.photo), fit: BoxFit.contain),
            ),
          ),
        ),
        // -------------------------------- About Seller------------------------------- //
